...
!function ($) {
    ...
    BootstrapTable.prototype.init = function () {
        ...
        if (this.options.showColumns) {
            $(".bootstrap-table-column-checkbox").on("change", function(e) {
                var field = $(this).attr("data-field")
                if(table_id && field) {
                    if($(this).prop('checked')) {
                        window.localStorage.setItem(table_id + "_" + field, "1")
                    } else {
                        window.localStorage.setItem(table_id + "_" + field, "0") 
                    }
                }
            })
            ...
            $(".bootstrap-table-column-checkbox").each(function() {
                var field = $(this).attr("data-field")
                var column_value = window.localStorage.getItem(table_id + "_" + field)
            ...
            $.each(this.columns, function (i, column) {
                ...
                if (column.switchable) {
                    html.push(sprintf('<li>' +
                        '<label><input type="checkbox" class="bootstrap-table-column-checkbox" data-field="%s" value="%s"%s> %s</label>' +
